...
<div data-page="service-planning" class="min-h-screen" style="background-color: #0a0e1a;">
    ...
    <aside 
        data-admin-sidebar
        class="fixed top-0 right-0 h-full w-80 border-l border-slate-800 flex flex-col z-50 transform translate-x-full transition-transform duration-300"
    ...
    >
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-[10px] text-slate-500 font-medium uppercase tracking-widest">
                        {{ config('ui.admin_service_planning.sidebar.title') }}
                    </p>
                </div>
            </div>
        </div>
        ...
        <nav class="flex-1 p-4">
            <ul class="space-y-1">
                @foreach(config('ui.admin_service_planning.sidebar.menu') as $item)
                    @php
                    ...
                    <li>
                        ...
                        @else
                            <a 
                                ...
                                data-action="close-sidebar"
                            >
                                <span class="material-symbols-outlined text-xl" @if($isCurrent) style="font-variation-settings: 'FILL' 1" @endif>
                                    {{ $item['icon'] }}
                                </span>
                                <span class="font-medium text-sm">{{ $item['label'] }}</span>
                            </a>
